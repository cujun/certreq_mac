...
//    }
    ...
    if (cert_cn) {
        ...
        SecKeyRef privateKeyRef=[TCSecurity generatePrivateKeyWithIdentifer:@"albatikelly"];
        NSData *publicKey=[TCSecurity generatePublicKeyFromPrivateKey:privateKeyRef];
        NSData *csr=[CertificateSigningRequest createCertificateSigningRequestWithCommonName:@"TCSCertRequest" publicKey:publicKey privateKey:privateKeyRef];
